...
ROUTES: tuple[Route, ...] = (
    ...
    Route(
        ...
        competitor_lesson="Firecrawl and Crawl4AI are stronger than Hermes Trailhead here; Hermes Trailhead should route to them rather than pretend to be a crawler.",
    ),
    Route(
        ...
        competitor_lesson="Browserbase wins on managed persistent contexts; Stagehand wins on browser primitives. Hermes Trailhead should be the policy gate before either.",
    ),
    Route(
        ...
        competitor_lesson="Agent-Reach/OpenCLI emphasize practical access to difficult sources; Hermes Trailhead should make platform coverage visible and route to the best available reader without overstating coverage.",
    ),
    Route(
        key="external-tool-enable",
        task="Install/enable external capability tool",
        primary="Hermes Trailhead plan + explicit approval",
        ...
        competitor_lesson="Composio/Pipedream/Arcade solve breadth with managed platforms; Hermes Trailhead should import candidates but keep local governance.",
    ),
)
